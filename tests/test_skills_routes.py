...
patches the SkillsService singleton so no access to /mnt/server530 is needed.
...
# Fixture skills directory — no /mnt/server530 required
...
def client(_app: FastAPI, fixture_service: SkillsService):
    ...
    /mnt/server530 singleton is never touched.
    """
    with patch(
