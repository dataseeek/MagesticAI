...
export function PRDetail({
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## ✅ Magestic AI PR Review - APPROVED\n\n${reviewResult.summary}\n\n---\n*This approval was generated by Magestic AI.*`;
  ...
  const handleAutoApprove = async () => {
    ...
    try {
      ...
      const approvalMessage = `## Magestic AI Review - APPROVED & MERGED
