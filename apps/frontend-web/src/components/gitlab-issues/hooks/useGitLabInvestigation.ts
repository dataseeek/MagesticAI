...
export function useGitLabInvestigation(projectId: string | undefined) {
  ...
  useEffect(() => {
    ...
    const cleanupProgress = window.API.onGitLabInvestigationProgress(
    ...
    const cleanupComplete = window.API.onGitLabInvestigationComplete(
    ...
    const cleanupError = window.API.onGitLabInvestigationError(
