...
function DroppableStatusColumn({
  ...
  return (
    ...
    >
      {/* Column header with colorful border */}
      <div className={cn(
        "flex items-center justify-between p-4 border-b-2",
        column.id === 'done' ? 'border-b-emerald-500/50' :
        column.id === 'in_progress' ? 'border-b-cyan-500/50' :
        column.id === 'planned' ? 'border-b-violet-500/50' :
