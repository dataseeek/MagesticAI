...
Stored in .magestic-ai/github/pr/ and .magestic-ai/github/issues/
...
class PRReviewResult:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save review result to .magestic-ai/github/pr/ with file locking."""
...
class TriageResult:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save triage result to .magestic-ai/github/issues/ with file locking."""
...
class AutoFixState:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save auto-fix state to .magestic-ai/github/issues/ with file locking."""
        issues_dir = github_dir / "issues"
        issues_dir.mkdir(parents=True, exist_ok=True)
