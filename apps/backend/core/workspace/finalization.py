    ...
    if choice == WorkspaceChoice.TEST:
        ...
        if staging_path:
            ...
            if worktree_path:
                ...
                print(
                    highlight(
                        f"  cd {project_dir}/.magestic-ai/worktrees/tasks/{spec_name}"
                    )
                )
        ...
        print(highlight(f"  python magestic-ai/run.py --spec {spec_name} --merge"))
        print()
        print("To discard (if you don't like it):")
        print(muted(f"  python magestic-ai/run.py --spec {spec_name} --discard"))
        print()
        ...
        print(muted(f"  python magestic-ai/run.py --spec {spec_name} --review"))
        print()
...
def review_existing_build(project_dir: Path, spec_name: str) -> bool:
    ...
    Called when user runs: python magestic-ai/run.py --spec X --review
    ...
    if not worktree_path:
        ...
        print(highlight(f"  python magestic-ai/run.py --spec {spec_name}"))
        return False
...
def discard_existing_build(project_dir: Path, spec_name: str) -> bool:
    ...
    Called when user runs: python magestic-ai/run.py --spec X --discard
