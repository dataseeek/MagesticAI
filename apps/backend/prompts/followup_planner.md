...
Next Steps:
Run `python magestic-ai/run.py --spec [SPEC_NUMBER]` to continue with new subtasks.
...
To continue building:
  python magestic-ai/run.py --spec [SPEC_NUMBER]
...
This spec has never been built. Please run:
  python magestic-ai/run.py --spec [NUMBER]
